...
<h1 class="text-center py-5">회원가입</h1>
    <div class="container">
        <form name="join01" action="join02.jsp" id="join01" class="join01" method="post">
           <div class="form-group mb-4">
              <label class="all"> 
               <input type="checkbox" name="all" id="all" value="ok">
               <span class="cbox"></span>
               이용약관, 개인정보 수집 및 이용, 위치정보 이용약관(선택)에
               모두 동의합니다.
              </label> 
            </div>
           ...
           <div class="form-group">
            <label class="all"> 
             <input type="checkbox" class="yak" id="yak01" name="yak01" value="ok">
             <span class="cbox"></span>
              회원 이용 약관 동의 <span class="text-danger">필수</span> 
            </label> 
           </div>
           ...
           <div class="form-group">
            <label class="all"> 
             <input type="checkbox" class="yak" id="yak02" name="yak02" value="ok">
             <span class="cbox"></span>
              개인정보 수집 및 이용 <span class="text-danger">필수</span> 
            </label> 
           </div>
           <div class="form-group pb-4">
               <p class="yak">
           ...
           <div class="form-group">
            <label class="all"> 
             <input type="checkbox" class="yak" id="yak03" name="yak03" value="ok">
             <span class="cbox"></span>
              위치정보 이용약관 <span class="text-primary">선택</span> 
            </label> 
           </div>
           ...
           <div class="text-center pb-4">
               <button type="reset" class="btn btn-danger py-2 px-5 mx-2"> 취 소 </button>
               <button type="submit" class="btn btn-primary  py-2 px-5 mx-2"> 확 인 </button>
           </div>
        </form>
    </div>